...
// template <typename Archive>
// void serialize(Archive& ar, Point& pl, [[maybe_unused]] const unsigned version) {
//     ar& pl.x;
//     ar& pl.y;
// }

// template <typename Archive>
// void serialize(Archive& ar, Player& pl, [[maybe_unused]] const unsigned version) {
//     ar& (pl.GetDogPtr());
// }

// template <typename Archive>
// void serialize(Archive& ar, model::Office& of, [[maybe_unused]] const unsigned version) {
//     ar& (of.GetId());
//     ar& (of.GetPosition());
//     ar& (of.GetOffset());
// }
...
// template <typename Archive>
// void serialize(Archive& ar, detail::Token& tok, [[maybe_unused]] const unsigned version) {
//     ar& (tok.id_dog_);
//     ar& (tok.token_string_);
// }
...
class MapRepresentation {
    ...
    std::vector <LootRepr> loot_list_;
    int bagCapacity = -1;
};
