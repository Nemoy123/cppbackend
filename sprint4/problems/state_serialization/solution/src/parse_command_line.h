...
[[nodiscard]] std::optional<Args> ParseCommandLine(int argc, const char* const argv[]) {
    ...
    add("state-file,s", po::value(&args.serialize_file)->value_name("file"s), "set serialize file path");
    add("save-state-period", po::value(&(args.save_period))->value_name("milliseconds"s), "savestate period milliseconds");
