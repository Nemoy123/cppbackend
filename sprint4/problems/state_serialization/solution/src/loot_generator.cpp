...
const LootGenerator::TimeInterval& LootGenerator::GetBaseInterval() const {return base_interval_;}
const double& LootGenerator::GetProbability() const {return probability_;}
