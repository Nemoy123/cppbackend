...
class Dog {
    public:
        ...
        bool CheckWaiting();
        void SetTimeWaiting (std::chrono::milliseconds update_time);
        const std::chrono::milliseconds& GetTimeWaiting () const;
        void SetTimePlaying (std::chrono::milliseconds update_time);
        const std::chrono::milliseconds& GetTimePlaying () const;
    ...
    private:
        ...
        size_t score = 0;
        std::chrono::milliseconds wait_time_ = 0ms;
        std::chrono::milliseconds total_play_time_ = 0ms;
};
...
class PlayersTokens {
    ...
    public:
        ...
        bool DeleteTokenByPlayer(std::shared_ptr<Player> player);
    private:
        TMap map_tokens_;
